...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mutpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14542&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mutpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mutpy` can be installed with:

```
conda install mutpy
```

It is possible to list all of the versions of `mutpy` available on your platform with:
